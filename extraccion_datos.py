...
"""Utilizacion de la librearia requests para obtener los datos de la URL"""
...
open ("bibliotecas/2022-julio/bibliotecas-14-07-2022.csv", "wb").write(datos_bibliotecas.content)
...
open ("museos/2022-julio/museos-14-07-2022.csv", "wb").write(datos_museos.content)
...
open ("cines/2022-julio/cines-14-07-2022.csv", "wb").write(datos_cines.content)
